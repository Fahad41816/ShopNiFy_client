    ...
    <section className="max-w-7xl mx-auto my-5">
      <div className="border-b-2 border-gray-100 flex items-center justify-between">
        ...
        <div className="flex gap-2 items-center justify-center">
            <div onClick={goToPreviousSlide}  className="btn px-2 rounded-none"><LuChevronLeft className="text-xl"/></div>
            <div onClick={goToNextSlide} className="btn px-2 rounded-none"><LuChevronRight className="text-xl"/></div>
        </div>
        </div>
      </div>
